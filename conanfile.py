...
class PxrPlugConan(ConanFile):
    name = "pxr-plug"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-plug"
    url = "https://github.com/untwine/pxr-plug"
    ...
    def configure(self):
        ...
        if self.options.python_version:
            ...
            self.options["pxr-work"].python_version = self.options.python_version
    ...
    def build_requirements(self):
        if self.options.build_tests:
            self.test_requires("pxr-gf/26.8")
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-plug"]
        self.cpp_info.libs = ["PxrPlug"]
