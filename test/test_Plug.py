...
class TestPlug(unittest.TestCase):
    ...
    def test_Registration(self):
        ...
        base1Subclasses = Tf.Type.FindByName('TestPlugBase<1>').GetAllDerivedTypes()
        ...
        base2Subclasses = Tf.Type.FindByName('TestPlugBase<2>').GetAllDerivedTypes()
    ...
    def test_ManufacturingCppDerivedClasses(self):
        ...
        self.assertEqual(tb1.GetTypeName(), 'TestPlugBase<1>')
        ...
        td1 = plug_test.TestPlugBase1('TestPlugDerived1')
        ...
        self.assertEqual(tb2.GetTypeName(), 'TestPlugBase<2>')
        ...
        td2 = plug_test.TestPlugBase2('TestPlugDerived2')
        ...
        self.assertFalse(pd1.DeclaresType(Tf.Type('TestPlugBase<1>'), includeSubclasses=False))
        self.assertTrue(pd1.DeclaresType(Tf.Type('TestPlugBase<1>'), includeSubclasses=True))
    ...
    def test_ManufacturingPythonDerivedClasses(self):
        ...
        # Check that plugin correctly reports its declared types.
        self.assertFalse(ppd1.DeclaresType(Tf.Type('TestPlugBase<1>'), 
                                    includeSubclasses=False))
        self.assertTrue(ppd1.DeclaresType(Tf.Type('TestPlugBase<1>'), 
    ...
    def test_MetadataAccess(self):
        base1Subclasses = Tf.Type.FindByName('TestPlugBase<1>').derivedTypes
        ...
        self.assertTrue(md['bases'] == ['TestPlugBase<1>'])
